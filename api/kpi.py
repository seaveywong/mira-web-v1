...
_OPT_GOALS_BY_OBJECTIVE = {
    ...
    "OUTCOME_SALES": [
        ...
        {"value": "MESSAGING_PURCHASE_CONVERSION", "label": "消息购买"},
        {"value": "LINK_CLICKS", "label": "链接点击（自动按流量目标投放）"},
        {"value": "LANDING_PAGE_VIEWS", "label": "落地页浏览（自动按流量目标投放）"},
        {"value": "REACH", "label": "触达人数（自动按认知目标投放）"},
        {"value": "IMPRESSIONS", "label": "展示次数（自动按认知目标投放）"},
        {"value": "CONVERSATIONS", "label": "聊天对话（自动按互动目标投放）"},
    ],
    "VIDEO_VIEWS": [
        {"value": "VIDEO_VIEWS", "label": "视频观看"},
        {"value": "THRUPLAY", "label": "ThruPlay"},
